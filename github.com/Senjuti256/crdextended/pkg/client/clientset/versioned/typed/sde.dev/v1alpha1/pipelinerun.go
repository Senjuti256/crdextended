...
import (
	...
	scheme "github.com/Senjuti256/crdextended/pkg/client/clientset/versioned/scheme"
...
func newPipelineRuns(c *SamplecontrollerV1alpha1Client, namespace string) *pipelineRuns {
	return &pipelineRuns{
		client: c.RESTClient(),
		ns:     namespace,
	}
