	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplecontrollerV1alpha1().TaskRuns(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplecontrollerV1alpha1().TaskRuns(namespace).Watch(context.TODO(), options)
			},
		},
		&sdedevv1alpha1.TaskRun{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *taskRunInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sdedevv1alpha1.TaskRun{}, f.defaultInformer)
}
