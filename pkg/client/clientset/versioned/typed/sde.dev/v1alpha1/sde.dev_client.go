...
import (
	...
	"github.com/Senjuti256/crdextended/pkg/client/clientset/versioned/scheme"
...
func (c *SamplecontrollerV1alpha1Client) PipelineRuns(namespace string) PipelineRunInterface {
	return newPipelineRuns(c, namespace)
}

func (c *SamplecontrollerV1alpha1Client) TaskRuns(namespace string) TaskRunInterface {
