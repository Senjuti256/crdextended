...
import (
	...
	sdedevv1alpha1 "github.com/Senjuti256/crdextended/pkg/apis/sde.dev/v1alpha1"
	versioned "github.com/Senjuti256/crdextended/pkg/client/clientset/versioned"
	internalinterfaces "github.com/Senjuti256/crdextended/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/Senjuti256/crdextended/pkg/client/listers/sde.dev/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplecontrollerV1alpha1().PipelineRuns(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplecontrollerV1alpha1().PipelineRuns(namespace).Watch(context.TODO(), options)
			},
		},
		&sdedevv1alpha1.PipelineRun{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pipelineRunInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sdedevv1alpha1.PipelineRun{}, f.defaultInformer)
}
